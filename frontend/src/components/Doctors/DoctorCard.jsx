    ...
    const DoctorCard = ({ doctor }) => {
        ...
        return (
          <div className="p-3 lg:p-5">
            ...
            <h2 className="text-[18px] leading-[30px] lg:text-[26px] lg:leading-[36px] text-headingColor font-[700] mt-3 lg:mt-5">
              {name}
            </h2>
...
<div className="mt-[18px] lg:mt-5 flex items-start justify-between flex-col">
