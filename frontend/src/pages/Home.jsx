...
function Home() {
  const customStyle = {
    margin: '0 auto',
    maxWidth: '80%' // Adjust the maxWidth value as per your requirement
  };
      ...
      <div className='container'>
        <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
          <div>
            ...
            <div className="mt-[30px] lg:mt-[70px] lg:gap-[30px] flex flex-col lg:flex-row items-center gap-5">
                    <div>
